 ...
 * Description: Custom clothes catalogue. Use the shortcode [rgb_clothes_create_form] to place the product creating form on pages. To customize the templates, copy the "template" folder to your theme and rename it to "rgb-clothes".
 * Author:      Applesinkin
 * Version:     0.0.1
 *
 * License:     GPL2
